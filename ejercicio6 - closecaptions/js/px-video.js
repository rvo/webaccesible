function InitPxVideo(options) {
	...
	obj.controls.innerHTML = '<div class="clearfix">' + 
			'<div class="pull-left">' + 
				'<button class="px-video-restart"><span class="sr-only">Reiniciar</span></button>' + 
				'<button class="px-video-rewind"><span class="sr-only">Retroceder <span class="px-seconds">10</span> seconds</span></button>' + 
				...
				'<button class="px-video-forward"><span class="sr-only">Adelantar <span class="px-seconds">10</span> seconds</span></button>' + 
			'</div>' + 
			'<div class="px-video-mute-btn-container pull-left">' + 
				'<input class="px-video-mute sr-only" id="btnMute'+obj.randomNum+'" type="checkbox" />' + 
				'<label id="labelMute'+obj.randomNum+'" for="btnMute'+obj.randomNum+'"><span class="sr-only">Suprimir audio</span></label>' + 
			'</div>' + 
			'<div class="pull-left">' + 
			...
			'<div class="px-video-captions-btn-container pull-left hide">' + 
				...
				'<label for="btnCaptions'+obj.randomNum+'"><span class="sr-only">Subtitulos</span></label>' + 
			'</div>' + 
			'<div class="px-video-fullscreen-btn-container pull-left show">' +
				...
				'<label for="btnFullscreen'+obj.randomNum+'"><span class="sr-only">Pantalla completa</span></label>' +
			'</div>' +
			'<div class="px-video-time">' + 
				'<span class="sr-only">tiempo</span> <span class="px-video-duration">00:00</span>' + 
			'</div>' + 
		'</div>' + 
		'<div>' + 
			'<progress class="px-video-progress" max="100" value="0"><span>0</span>% reproducido</progress>' + 
		'</div>';
